...
// You will no longer need to import a separate CSS file.
// All styles are now included directly as class names.
  ...
  return (
    <div className="bg-white text-gray-800 font-sans leading-relaxed">
      ...
      <header className="py-20 text-center bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto transition ease-in-out duration-100">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto md:flex md:items-center md:gap-12 ease-in ">
          {/* Text Content */}
...
<img src="https://img.freepik.com/free-photo/stylish-shoes-isolated_23-2147694244.jpg" />          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-center text-3xl sm:text-4xl font-semibold mb-12 text-gray-900">
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Quality Craftsmanship</h3>
              <p className="text-gray-600">We are committed to creating products that stand the test of time. We use premium materials and pay close attention to every detail.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Customer-Centric Focus</h3>
              <p className="text-gray-600">Our customers are at the heart of our brand. We listen to your feedback and strive to exceed your expectations in every interaction.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Sustainable Practices</h3>
              <p className="text-gray-600">We believe in building a brand that's not only good for you but also for the planet. We're dedicated to sourcing ethically.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Seamless Experience</h3>
              <p className="text-gray-600">We believe shopping should be easy and enjoyable. Our goal is to provide a clean, simple website, fast shipping, and a hassle-free return process.</p>
            </div>
          </div>
        </div>
      </section>
     <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-indigo-500 to-purple-600 overflow-hidden">
  {/* Background Overlays for effect */}
  ...
  {/* Content Wrapper */}
  <div className="relative max-w-4xl mx-auto text-center z-10 p-8 bg-white/10 backdrop-blur-sm rounded-xl shadow-2xl border border-white/20">

    {/* Founder Image */}
    <img
      src="https://randomuser.me/api/portraits/men/32.jpg"
      alt="Founder - John Doe"
      className="w-36 h-36 mx-auto rounded-full object-cover mb-8 border-4 border-white shadow-xl transform hover:scale-105 transition-transform duration-300 ease-in-out"
    />
